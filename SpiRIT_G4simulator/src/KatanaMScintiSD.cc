...
KatanaMScintiSD::KatanaMScintiSD(G4String name)
 : G4VSensitiveDetector(name), fNumberOfBar(12), fScintiCollection(0)
{
  ...
  G4String HCname;
  collectionName.insert(HCname="KatanaMScintiCollection");
}

KatanaMScintiSD::~KatanaMScintiSD()
{;}

void KatanaMScintiSD::Initialize(G4HCofThisEvent* HCTE)
{
...
//G4bool KatanaMScintiSD::ProcessHits(G4Step* aStep, G4TouchableHistory* ROhist)
G4bool KatanaMScintiSD::ProcessHits(G4Step* aStep, G4TouchableHistory*)
{
...
void KatanaMScintiSD::EndOfEvent(G4HCofThisEvent*)
{
