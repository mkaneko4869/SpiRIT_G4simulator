...
KatanaVScintiSD::KatanaVScintiSD(G4String name)
 : G4VSensitiveDetector(name), fNumberOfBar(3), fScintiCollection(0)
{
  ...
  G4String HCname;
  collectionName.insert(HCname="KatanaVScintiCollection");
}

KatanaVScintiSD::~KatanaVScintiSD()
{;}

void KatanaVScintiSD::Initialize(G4HCofThisEvent* HCTE)
{
...
//G4bool KatanaVScintiSD::ProcessHits(G4Step* aStep, G4TouchableHistory* ROhist)
G4bool KatanaVScintiSD::ProcessHits(G4Step* aStep, G4TouchableHistory*)
{
...
void KatanaVScintiSD::EndOfEvent(G4HCofThisEvent*)
{
